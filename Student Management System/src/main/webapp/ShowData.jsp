...
<div class="container">
    ...
    <h1>Show Account Holder Details</h1>
    <%
        ...
        try {
            ...
            if (rs.next()) {
                ...
                PreparedStatement ps1 = conn.prepareStatement("SELECT * FROM program WHERE program_id = ?");
                ps1.setInt(1, programId);
    ...
    %>
    <p class="error">No found for Account Number: <%= rollNumber %></p>
    <%
            }
