...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (StudentModel.validateUser(rollNumber, username)) {
                ...
                // User not found - Add user and redirect to welcome page
                 ...
                 session.setAttribute("rollNumber", rollNumber);
                 session.setAttribute("username", username);
                StudentModel.addUser(rollNumber, username);
                response.sendRedirect("welcome.jsp"); // Redirect to welcome page after adding user
            }
